...
import { IconType } from "react-icons"; // Import the IconType type from the react-icons package
    ...
    >
      {items.map((item, idx) => {
        ...
        >
          ...
          ring-purple-600 relative z-20 transition-all  duration-500 cursor-pointer">
